...
-- Close current buffer (nvim tabs)
-- vim.keymap.set('n', '<C-w>', '<cmd> bw <CR>', opts)
-- vim.keymap.set('n', '<C-w>', 'bd!', opts)
-- vim.keymap.set('i', '<C-w>', '<cmd> bw <CR>', opts)
-- vim.keymap.set('i', '<C-w>', 'bd!', opts)
vim.keymap.set('n', '<leader>w', '<Cmd>bd<CR>', { desc = 'Close buffer' })
vim.keymap.set('n', '<leader>W', '<Cmd>bd!<CR>', { desc = 'Force close buffer' })
